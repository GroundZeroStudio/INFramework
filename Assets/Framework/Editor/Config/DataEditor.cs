...
{
    public static string XmlPath = LoadFrameConfig.GetFrameConfig().m_XmlPath;
    public static string JsonPath = "Assets/GameData/Data/Json/";
    public static string BinaryPath = LoadFrameConfig.GetFrameConfig().m_BinaryPath;//"Assets/GameData/Data/Binary/";
    public static string ScriptsPath = LoadFrameConfig.GetFrameConfig().m_ScriptsPath;//"Assets/Scripts/ConfigData/";
    public static string ExcelPath = Application.dataPath + "/../Data/Excel/";
    public static string RegPath = Application.dataPath + "/../Data/Reg/";

    [MenuItem("Tool/Json/测试")]
    public static void JsonTest()
    {
        string excelPath = ExcelPath + "G怪物.xlsx";
        string jsonPath = JsonPath + "G怪物.json";
    ...
    [MenuItem("Tools/Excel/Excel转Xml")]
    ...
    [MenuItem("Tools/Excel/Excel转Json")]
    ...
    [MenuItem("Tools/测试/Xml写入Excel")]
    public static void TestXmlToExcel()
    {
        XmlToExcel("MonsterData");
    }
    ...
    private static void ExcelToXml(string name)
    {
        ...
        SerializeHelper.XmlSerialize(XmlPath + xmlName, objClass);
    ...
    private static object GetObjFormXml(string name)
    {
        ...
        if (type != null)
        {
            ...
            return SerializeHelper.XmlDeserialize(xmlPath, type);
        }
    ...
    private static void XmlToBinary(string name)
    {
        ...
        try
        {
            ...
            if (type != null)
            {
                ...
                object obj = SerializeHelper.XmlDeserialize(xmlPath, type);
                SerializeHelper.BinarySerialize(binaryPath, obj);
    ...
    private static void ClassToXml(string name)
    {
        ...
        try
        {
            ...
            if (type != null)
            {
                ...
                string xmlPath = XmlPath + name + ".xml";
                SerializeHelper.XmlSerialize(xmlPath, temp);
